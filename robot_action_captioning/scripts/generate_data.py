...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=bool,
        default=True,
        help="Visualize the episode",
    )
    args = parser.parse_args()
    episode_data = extract_episode_data(args.dataset_path, args.episode_id)
    prompt = generate_prompt(episode_data)
    generate_action_caption(args.llm_model, prompt, args.visualize)